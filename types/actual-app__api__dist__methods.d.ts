declare module '@actual-app/api/dist/methods.js' {
  // Minimal ambient declarations used by the adapter and tests.
  export function addTransactions(...args: unknown[]): Promise<unknown>;
  export function getAccounts(...args: unknown[]): Promise<unknown>;
  export function importTransactions(...args: unknown[]): Promise<unknown>;
  export function getTransactions(...args: unknown[]): Promise<unknown>;
  export function getCategories(...args: unknown[]): Promise<unknown>;
  export function createCategory(...args: unknown[]): Promise<unknown>;
  export function getPayees(...args: unknown[]): Promise<unknown>;
  export function createPayee(...args: unknown[]): Promise<unknown>;
  export function getBudgetMonths(...args: unknown[]): Promise<unknown>;
  export function getBudgetMonth(...args: unknown[]): Promise<unknown>;
  export function setBudgetAmount(...args: unknown[]): Promise<unknown>;
  ...
  export function updateTransaction(...args: unknown[]): Promise<unknown>;
  export function deleteTransaction(...args: unknown[]): Promise<unknown>;
  export function updateCategory(...args: unknown[]): Promise<unknown>;
  export function deleteCategory(...args: unknown[]): Promise<unknown>;
