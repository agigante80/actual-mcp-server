...
> **✅ Verified**: All 74 tools tested and working with LibreChat (HTTP/HTTPS + OIDC) and Claude Desktop (stdio native + mcp-remote).

## 🚀 Features

- **74 Implemented Tools** - Comprehensive coverage of the Actual Budget API (84% of methods)
...
> No auth token needed. All 74 tools available. Claude Desktop spawns the process and owns its lifecycle.
